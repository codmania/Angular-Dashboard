app.controller('AiriqsearchHistoryCtrl',
    ['$scope', '$stateParams', '$localStorage', '$window', 'Futuredate', '$timeout', function ($scope, $stateParams, $localStorage, $window, Futuredate, $timeout) {
        ...
        var canvasUpper = document.getElementById("history-diff-upper");
        ...
        $scope.buildReport = function() {
            ...
            var searchString = from + '/' + to + '/' + formatDate(od)
                + '/period/' + formatDate(sd) + '/' + formatDate(ed);
